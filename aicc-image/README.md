# AICC 이미지 스킬 설치 안내 (왕초보용)

Claude 에서 ChatGPT 의 이미지 생성 기능을 그대로 쓰게 해주는 도구입니다.
어떤 이미지든 만들고 편집할 수 있고, "그림일기"(사진+일기 → 여행 기록 포스터)
프리셋이 들어 있습니다. ChatGPT 유료 구독만 있으면 되고, 별도 결제는 없습니다.
...
- "노을 지는 바닷가 그림 그려줘" (어떤 이미지든 됩니다)
- "이 사진에서 배경만 바꿔줘" + 사진 끌어다 놓기
- "이 사진으로 그림일기 만들어줘" + 사진 끌어다 놓기 + 일기 한두 문장
